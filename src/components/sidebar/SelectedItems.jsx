...
function SelectedItems({
  ...
  return editMode ? (
    ...
    <li
      ...
      className={`ease selected-list-item @container flex w-full cursor-grab touch-none rounded-md border-1 border-gray-300 bg-white py-5 pr-2 pl-1 transition-colors duration-200`}
    >
